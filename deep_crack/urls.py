...
from mains import views as main_views
...
urlpatterns = [
    ...
    path('predict_image/',user_views.predict_image,name='predict_image'),
    ...
    path('rfcn_b_alg/',admin_views.rfcn_b_alg,name='rfcn_b_alg'),
